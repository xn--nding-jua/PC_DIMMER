...
interface
 ...
 type TWaveform = Class(TObject)
    ...
    public
     ...
     procedure Draw(HWND : THandle; WaveData : TWaveData; X, Y , length: Integer);
 ...
 var Waveform : TWaveform;

implementation

     Constructor TWaveform.Create(Width, Height : Integer);
      begin
     ...
     procedure TWaveform.SetBackGround (Active : Boolean; BkgCanvas : TGraphic);
      begin
        UseBkg := Active;
        BackBmp.Canvas.Draw(0, 0, BkgCanvas);
      end;

     procedure TWaveform.Draw(HWND : THandle; WaveData : TWaveData; X, Y ,length: Integer);
