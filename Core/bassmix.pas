...
function BASS_Mixer_ChannelGetPositionEx(handle, mode, delay: DWORD): QWORD; stdcall; external bassmixdll;
...
function BASS_Split_StreamGetSplits(handle: DWORD; var splits: HSTREAM; count: DWORD): DWORD; stdcall; external bassmixdll;
function BASS_Split_StreamReset(handle: DWORD): BOOL; stdcall; external bassmixdll;
function BASS_Split_StreamResetEx(handle, offset: DWORD): BOOL; stdcall; external bassmixdll;
function BASS_Split_StreamGetAvailable(handle: DWORD): DWORD; stdcall; external bassmixdll;
