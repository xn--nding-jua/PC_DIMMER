...
uses szenenpanelfrm, editmidievent;
    ...
    begin
      MIDIGrid.cells[1,line]:='-';
		...
		case mainform.MidiEventArray[line-1][4] of				// Typ
			0: MIDIGrid.cells[3,line]:=_('Kanalwert (Dynamisch)');
			1: MIDIGrid.cells[3,line]:=_('Kanalwert (Statisch)');
			2: MIDIGrid.cells[3,line]:=_('Button');
			3: MIDIGrid.cells[3,line]:=_('Geschwindigkeit');
			4: MIDIGrid.cells[3,line]:=_('Systemlautstärke');
			5: MIDIGrid.cells[3,line]:=_('Mute');
			6: MIDIGrid.cells[3,line]:=_('Grandmaster');
			7: MIDIGrid.cells[3,line]:=_('Flashmaster');
			8: MIDIGrid.cells[3,line]:=_('Springe zu Kanal');
		end;
