object mainform: Tmainform
  ...
  Caption = 'PC_DIMMER DMX512-Recorder'
  ClientHeight = 351
  ClientWidth = 433
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Height = 13
    Caption = 
      'Zeichnen Sie den DMX512-Datenstrom in einer Datei zur weiteren V' +
      'erarbeitung auf...'
  end
  ...
  object GroupBox1: TGroupBox
    ...
    object Label3: TLabel
      ...
      Width = 109
      Height = 13
      Caption = 'Aufzeichnungsintervall:'
    end
  ...
  object GroupBox2: TGroupBox
    ...
    object RadioButton4: TRadioButton
      ...
      Width = 145
      Height = 17
      Caption = 'Beginn/Ende eines Fades'
      Checked = True
      TabOrder = 1
      TabStop = True
    end
    object CheckBox1: TCheckBox
      ...
      Width = 137
      Height = 17
      Caption = 'Fading-Infos auswerten'
      Checked = True
      State = cbChecked
      TabOrder = 2
    end
  end
  object RecordTimer: TCHHighResTimer
