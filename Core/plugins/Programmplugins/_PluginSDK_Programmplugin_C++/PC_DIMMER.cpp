...
char * __stdcall DLLIdentify()
{
  ...
  return ("Input") ; // Output oder Input
}
...
char * __stdcall DLLGetName()
{
  ...
  return ("PC_DIMMER Programm-Plugindemo für C++") ;
}

void __stdcall DLLShow()
{
  // Funktionsaufruf bei Klick auf "Konfigurieren"
  MessageBox(NULL, "This is DLLShow", "PC_DIMMER-Plugin", MB_OK | MB_ICONEXCLAMATION) ;
  return ;
}
