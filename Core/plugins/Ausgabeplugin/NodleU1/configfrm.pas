...
function GetAllConnectedInterfaces: TSERIALLIST; stdcall external 'Nodle_USB.dll';
function GetAllOpenedInterfaces: TSERIALLIST; stdcall external 'Nodle_USB.dll';
function SetInterfaceMode(Serial: TSERIAL; Mode: byte): DWORD; stdcall external 'Nodle_USB.dll';
function OpenLink(Serial: TSERIAL; DMXOutArray: Pointer; DMXInArray: Pointer): DWORD; stdcall external 'Nodle_USB.dll';
function CloseLink(Serial: TSERIAL): DWORD; stdcall external 'Nodle_USB.dll';
function CloseAllLinks: DWORD; stdcall external 'Nodle_USB.dll';
function RegisterInterfaceChangeNotification(Proc: THOSTDEVICECHANGEPROC): DWORD; stdcall external 'Nodle_USB.dll';
function UnregisterInterfaceChangeNotification: DWORD; stdcall external 'Nodle_USB.dll';
function RegisterInputChangeNotification(Proc: THOSTINPUTCHANGEPROC): DWORD; stdcall external 'Nodle_USB.dll';
function UnregisterInputChangeNotification: DWORD; stdcall external 'Nodle_USB.dll';
function GetDeviceVersion(Serial: TSERIAL): DWORD; stdcall external 'Nodle_USB.dll';
function SetInterfaceAdvTxConfig(Serial: TSERIAL; Control: Byte; Breaktime: word; Marktime: word; Interbytetime: word; Interframetime: word; Channelcount: word; Startbyte: byte): DWORD; stdcall; stdcall external 'Nodle_USB.dll';
function StoreInterfaceAdvTxConfig(Serial: TSERIAL): DWORD; stdcall; stdcall external 'Nodle_USB.dll';
function RegisterInputChangeBlockNotification(Proc: THOSTINPUTCHANGEPROCBLOCK): DWORD; stdcall external 'Nodle_USB.dll';
function UnregisterInputChangeBlockNotification: DWORD; stdcall external 'Nodle_USB.dll';
