 ...
 */
typedef	int		(USBDMX_TYPE USBDMX_TYPE_DMXTX)				
		(IN HANDLE /* h */, IN UCHAR /* universe */, IN USHORT /* slots */, IN const void * /* buffer */);
 ...
 *			<  0		- reception error
 */
typedef	int		(USBDMX_TYPE USBDMX_TYPE_DMXRX)
		(IN HANDLE /* h */, IN UCHAR /* universe */, USHORT /* buffersize */, OUT void * /* buffer */);
 ...
 */
typedef	int		(USBDMX_TYPE USBDMX_TYPE_RDM)
		(IN HANDLE /* h      */, IN UCHAR   /* universe */, IN UCHAR /* txlen */, IN const void * /* txbuffer */, 
		 IN UCHAR  /* rxsize */, OUT void * /* rxbuffer */);
 ...
 *			< 0				- handling/reception error
 */
typedef int		(USBDMX_TYPE USBDMX_TYPE_RDMDISCOVERY)
		(IN HANDLE /* h      */, IN UCHAR   /* universe */, IN UCHAR /* txlen */, IN const void * /* txbuffer */, 
		 IN UCHAR  /* rxsize */, OUT void * /* rxbuffer */);
...
struct usbdmx_functions {
	 ...
	 *			< 0				- handling/reception error
	 */
	USBDMX_TYPE_RDMDISCOVERY		rdmdiscovery;
};
