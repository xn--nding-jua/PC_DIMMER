...
void CDMXDemoDlg::OnCustomdrawChannel(NMHDR* pNMHDR, LRESULT* pResult) 
{
	...
	data[0]  = 0xFF;
	data[1]  = FirstChannel%256;
	data[2]  = FirstChannel/256;
	data[3]  = NrOfBytes;
	data[4]  = (BYTE)((100-m_ch1)*2.551);
	data[5]  = (BYTE)((100-m_ch2)*2.551);
	data[6]  = (BYTE)((100-m_ch3)*2.551);
	data[7]  = (BYTE)((100-m_ch4)*2.551);
	data[8]  = (BYTE)((100-m_ch5)*2.551);
	data[9]  = (BYTE)((100-m_ch6)*2.551);
	data[10] = (BYTE)((100-m_ch7)*2.551);
	data[11] = (BYTE)((100-m_ch8)*2.551);
	data[12] = (BYTE)((100-m_ch9)*2.551);
	data[13] = (BYTE)((100-m_ch10)*2.551);

	FT_Write(ftHandle, data, NrOfBytes+4,&dwBytesWritten);
