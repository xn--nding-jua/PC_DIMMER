...
type
  TDelphiXDXPlayForm = class(TForm)
    ...
    procedure ProviderListDblClick(Sender: TObject);
  private
    FProviderGUID: TGUID;
  public
...
begin
  ...
  ProviderList.ItemIndex:=ProviderList.Items.Count-1;
...
procedure TDelphiXDXPlayForm.ProviderListDblClick(Sender: TObject);
begin
  NextButton.Click;
end;
